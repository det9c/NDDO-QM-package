...
c       --------------------------------------------------------------------
c 
	subroutine conjugate(natoms,nopt,force,q,internal,icount2)
c
...
c
	...
	double precision f,eps,tlev,rnorm
        double precision time1,time2,tottime,force,q(natoms,3)
        logical          finish
	integer          iprint(2),iflag,icall,n,method,mp,lp,i
        integer          iter,nfun,natoms,nopt
	integer internal(2,nopt),icount
	common /cgdd/    mp,lp
...
c Rosenbrock test function
	call fcn(n,x,f,g,natoms,q,internal,force,rnorm)
