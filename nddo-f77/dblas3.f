C     ******************************************************************
C
C     Level 3 BLAS routines obtained from netlib.ornl.gov (October 1996)
C
C     Reference.
C     J.J. Dongarra, J. DuCroz, S. Hammarling, and I. Duff, ACM
C     Transactions on Mathematical Software 16 (1990) 1-17, 18-28.
C     A Set of  Level 3  Basic Linear Algebra Subprograms.
C
C     ******************************************************************
C
C     This file contains the subroutines DGEMM, DSYMM, DSYRK, DSYR2K,
C     DTRMM, and DTRSM (all dated on 08 Feb 1989) and LOGICAL FUNCTION
C     LSAM (dated 29 Feb 1992, from LAPACK).
C
C     ******************************************************************
*
