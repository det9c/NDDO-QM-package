...
ilent=num_gauss**2
call mpi_bcast(density_global,ilent,mpi_double_precision,0,mpi_comm_world,ierr)
call mpi_bcast(density_q,ilent,mpi_double_precision,0,mpi_comm_world,ierr)
call mpi_barrier(mpi_comm_world,ierr)
